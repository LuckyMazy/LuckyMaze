...
- **Name:** used in the `groups` claim of the OIDC token — this is what LuckyMaze checks for role-based access
...
## 6. Create an OIDC client for LuckyMaze
