...
namespace LuckyMaze.Application.Command
{
    ...
    public class SendMessageCommandHandler(IUserService userService, LuckyMazeDbContext dbContext, IChatCompletionService chatCompletionService, ICreditsService creditsService) : ICommandHandler<SendMessageCommand, Result<SendMessageDto>>
    {
